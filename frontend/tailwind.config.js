  ...
  safelist: [
    {
      // 基本色階（含透明度）
      pattern:
        /(bg|text|border|shadow|stroke|fill)-(sky|indigo|amber|emerald|violet|blue|cyan|teal|yellow|orange|green|purple|red|gray|rose)-(50|100|200|300|400|500|600|700|800|900)(\/\d{2})?/,
    },
    {
      // 漸層用色
      pattern:
